...
# KFall/ -- two levels up now (fall_pattern_analysis/paper_threshold_validation/ -> KFall/),
# makes this script cwd-independent.
...
# D01-D19 = task ids 1-19; D20-D21 = task ids 35-36 (NOT 20-21, which are the fall
# tasks F01/F02 -- a range(1,22) here would silently double-count 313 fall trials
# as ADL, contaminating every specificity number computed from it).
